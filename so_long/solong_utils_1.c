...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/11 12:12:42 by adahab            #+#    #+#             */
/*   Updated: 2025/04/11 12:16:05 by adahab           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	error_found(char type)
{
	...
	if (type == 1)
		...
		ft_printf("map missing components or exit/spawn is duplicated !\n");
	else if (type == 3)
		...
		ft_printf("soft locked ! (no path to the exit or the collectables)\n");
	else if (type == 8)
